                ...
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
                        ...
                        <div className="mb-4.5 flex items-center justify-center gap-5">
                            <Link to='/user/post/update-image/ab21ib' className="border-2 border-webred px-6 py-2 hover:bg-webred text-black dark:text-white">Update Image</Link>
                            <Link to='/user/post/update-details/ab21ib' className="border-2 border-webred px-6 py-2 hover:bg-webred text-black dark:text-white">Update Details</Link>
